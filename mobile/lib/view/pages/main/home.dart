...
class _HomePageState extends ConsumerState<HomePage> {
  ...
  Future<void> _createConversationAndNavigate(String title) async {
    ...
    try {
      ...
      final created = await conversationsNotifier.createConversation(newConversation);
      ...
      if (created != null && mounted) {
        ...
        _handleOptionActionWithConversation(_selectedOption!, created.id, created.title);
      } else if (mounted) {
  ...
  void _handleOptionActionWithConversation(int index, String conversationId, String? title) {
