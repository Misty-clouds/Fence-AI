...
import 'package:fence_ai/features/research/data/models/research_conversation_model.dart';
import 'package:fence_ai/features/users/data/models/users_model.dart';
import 'package:fence_ai/features/auth/providers/auth_provider.dart';
...
class _HomePageState extends ConsumerState<HomePage> {
  ...
  void _handleOptionActionWithConversation(
    ...
    switch (index) {
      case 0:
        context.push('${Routes.map}?conversationId=${Uri.encodeQueryComponent(conversationId)}');
        break;
      case 1:
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Coming soon')));
        break;
      case 2:
        context.push(Uri(path: Routes.research, queryParameters: {
